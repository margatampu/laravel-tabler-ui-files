...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCOJwXN0eoyeFZ3cYtGzPLFw8zGhQ750Xk"></script>
<!-- <script src="{{ mix('/js/jvectormap.js') }}" charset="utf-8"></script> -->
@endsection
