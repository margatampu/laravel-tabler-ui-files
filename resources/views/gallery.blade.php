                ...
                <div class="card p-3">
                    ...
                    <div class="d-flex align-items-center px-2">
                        ...
                        <div class="ml-auto text-muted">
                            <a href="#" class="icon"><i class="fe fe-eye mr-1"></i> 112</a>
                            <a href="#" class="icon d-none d-md-inline-block ml-3"><i class="fe fe-heart mr-1"></i> 42</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                    ...
                    <div class="d-flex align-items-center px-2">
                        ...
                        <div class="ml-auto text-muted">
                            <a href="#" class="icon"><i class="fe fe-eye mr-1"></i> 70</a>
                            <a href="#" class="icon d-none d-md-inline-block ml-3"><i class="fe fe-heart mr-1"></i> 0</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                    ...
                    <div class="d-flex align-items-center px-2">
                        ...
                        <div class="ml-auto text-muted">
                            <a href="#" class="icon"><i class="fe fe-eye mr-1"></i> 166</a>
                            <a href="#" class="icon d-none d-md-inline-block ml-3"><i class="fe fe-heart mr-1"></i> 96</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                    ...
                    <div class="d-flex align-items-center px-2">
                        ...
                        <div class="ml-auto text-muted">
                            <a href="#" class="icon"><i class="fe fe-eye mr-1"></i> 76</a>
                            <a href="#" class="icon d-none d-md-inline-block ml-3"><i class="fe fe-heart mr-1"></i> 6</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                    ...
                    <div class="d-flex align-items-center px-2">
                        ...
                        <div class="ml-auto text-muted">
                            <a href="#" class="icon"><i class="fe fe-eye mr-1"></i> 106</a>
                            <a href="#" class="icon d-none d-md-inline-block ml-3"><i class="fe fe-heart mr-1"></i> 36</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                    ...
                    <div class="d-flex align-items-center px-2">
                        ...
                        <div class="ml-auto text-muted">
                            <a href="#" class="icon"><i class="fe fe-eye mr-1"></i> 77</a>
                            <a href="#" class="icon d-none d-md-inline-block ml-3"><i class="fe fe-heart mr-1"></i> 7</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                    ...
                    <div class="d-flex align-items-center px-2">
                        ...
                        <div class="ml-auto text-muted">
                            <a href="#" class="icon"><i class="fe fe-eye mr-1"></i> 150</a>
                            <a href="#" class="icon d-none d-md-inline-block ml-3"><i class="fe fe-heart mr-1"></i> 80</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                    ...
                    <div class="d-flex align-items-center px-2">
                        ...
                        <div class="ml-auto text-muted">
                            <a href="#" class="icon"><i class="fe fe-eye mr-1"></i> 153</a>
                            <a href="#" class="icon d-none d-md-inline-block ml-3"><i class="fe fe-heart mr-1"></i> 83</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                    ...
                    <div class="d-flex align-items-center px-2">
                        ...
                        <div class="ml-auto text-muted">
                            <a href="#" class="icon"><i class="fe fe-eye mr-1"></i> 143</a>
                            <a href="#" class="icon d-none d-md-inline-block ml-3"><i class="fe fe-heart mr-1"></i> 73</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                    ...
                    <div class="d-flex align-items-center px-2">
                        ...
                        <div class="ml-auto text-muted">
                            <a href="#" class="icon"><i class="fe fe-eye mr-1"></i> 149</a>
                            <a href="#" class="icon d-none d-md-inline-block ml-3"><i class="fe fe-heart mr-1"></i> 79</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                    ...
                    <div class="d-flex align-items-center px-2">
                        ...
                        <div class="ml-auto text-muted">
                            <a href="#" class="icon"><i class="fe fe-eye mr-1"></i> 164</a>
                            <a href="#" class="icon d-none d-md-inline-block ml-3"><i class="fe fe-heart mr-1"></i> 94</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-4">
                <div class="card p-3">
                    ...
                    <div class="d-flex align-items-center px-2">
                        ...
                        <div class="ml-auto text-muted">
                            <a href="#" class="icon"><i class="fe fe-eye mr-1"></i> 160</a>
                            <a href="#" class="icon d-none d-md-inline-block ml-3"><i class="fe fe-heart mr-1"></i> 90</a>
                        </div>
                    </div>
                </div>
            </div>
